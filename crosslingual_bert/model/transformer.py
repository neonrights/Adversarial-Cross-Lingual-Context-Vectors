...
class Decoder(nn.Module):
    ...
    def forward(self, encoder_states, decoder_states, attention_mask, output_all_decoded_layers=True):
        all_decoder_layers = []
        for layer_module in self.layer:
            hidden_states = layer_module(decoder_states, decoder_states, attention_mask)
