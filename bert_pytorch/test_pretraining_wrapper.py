...
from trainer import AdversarialPretrainingWrapper
...
pretrain_model = AdversarialPretrainingWrapper(model, DummyAdversary(256, len(language_ids)), 256, vocab_size)
