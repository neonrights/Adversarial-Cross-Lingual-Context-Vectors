...
language_data = LanguageDataset('test_language.txt', vocab, language='en', seq_len=256)
...
language_data = LanguageDataset('test_language.txt', vocab, language='en', seq_len=256, on_memory=False)
language_loader = DataLoader(language_data, batch_size=32, shuffle=True)
